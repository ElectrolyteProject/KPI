...
task_metainfo = {
    ...
    "mp": {
    "mean": 370.56718514266515,
    "std": 98.35883418289626,
    "target_name": "mp",
    },
        
    "bp": {
    "mean": 449.79778501888063,
    "std": 82.50326103446407,
    "target_name": "bp",
    },
     
    "fp": {
    "mean": 355.9237093518721,
    "std": 57.46020463798243,
    "target_name": "fp",
    },
}
...
class UniMolFinetuneTask(UnicoreTask):
    ...
    def load_dataset(self, split, **kwargs):
        ...
        if split == "train":
            ...
            # change_begin
            # successful!
            know_dataset = KeyDataset(dataset, "knowledge")
            # change_over
        ...
        nest_dataset = NestedDictionaryDataset(
            {
                "net_input": {
                    ...
                    # change_begin
                    # RawArrayDataset or RawNumpyDataset which I can't decide.
                    "finetune_knowledge": RawArrayDataset(know_dataset),
                    # change_over
                },
                "target": {
